...
def predict(
    ...
    # Step 5: Load model & align input columns to what the model expects (preferred) or fallback to train schema
    model = load(model_path)

    # Prefer model's recorded feature names (if available) to align inputs
